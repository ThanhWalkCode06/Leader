                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Thêm mới Account</li>
                        </ol>
                    </div>
                ...
                <div class="h-100">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Thêm mới Account</h4>
                        </div><!-- end card header -->
                            ...
                            <div class="live-preview">
                                <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row gy-4">
                                        <div class="col-md-4">
                                            <div class="mt-3">
                                                <label for="ma_nhan_vien" class="form-label">Mã Account</label>
                                                <input type="text"
                                                    class="form-control @error('ma_nhan_vien') is-invalid @enderror"
                                                    name="ma_nhan_vien" id="ma_nhan_vien"
                                                    value="ACC{{ strtoupper(rand(1, 9999)) }}" readonly>
                                                @error('ma_nhan_vien')
