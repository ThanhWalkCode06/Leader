            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn material-shadow-none" id="page-header-user-dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                @if(session('userName'))
                                    <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">Chào {{ session('userName') }}</span>
                                @endif
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="{{ route('edit.pass') }}"><i
                                class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span
                                class="align-middle">Đổi mật khẩu</span></a>


                                    @csrf
                                    <button style="border:10px" type="submit">
